...
export function createFakeD1() {
    ...
    if (process.env.TEST_DATABASE_URL) return createPgTestDb(process.env.TEST_DATABASE_URL, ['0001_init.sql', '0002_auth_rate_limits.sql', '0003_discounts_returns.sql', '0004_payments.sql']);
